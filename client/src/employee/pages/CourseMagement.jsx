...
const courseAPI = {
  getAllCourses: async () => {
    try {
      ...
      const response = await fetch('https://crm-c1y4.onrender.com/apicourses', {
        method: 'GET',
        headers: {
  ...
  updateCourse: async (courseId, courseData) => {
    const response = await fetch(`https://crm-c1y4.onrender.com/apicourses/${courseId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  addStudent: async (courseId, studentData) => {
    const response = await fetch(`https://crm-c1y4.onrender.com/apicourses/${courseId}/students`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  updateStudent: async (courseId, studentId, studentData) => {
    const response = await fetch(`https://crm-c1y4.onrender.com/apicourses/${courseId}/students/${studentId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  updateReminder: async (courseId, studentId, reminderMessage) => {
    const response = await fetch(`https://crm-c1y4.onrender.com/apicourses/${courseId}/students/${studentId}/reminder`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json'
      },
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
        ...
        {error.includes('server') && (
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded text-sm text-yellow-800">
            ...
            <p>• Verify API endpoint: https://crm-c1y4.onrender.com/apicourses</p>
