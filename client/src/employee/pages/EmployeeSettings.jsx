...
const EmployeeSettings = () => {
  ...
  const fetchEmployeeData = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://crm-server-jl9z.onrender.com/api/employee/me", {
        headers: {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://crm-server-jl9z.onrender.com/api/employee/me/change-password", {
        method: "PATCH",
        headers: {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://crm-server-jl9z.onrender.com/api/employee/me/update-profile", {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`
